...
var beforeEach = function() {
	//mock the request
	nock('http://www.zillow.com').get('/homes/15539566_zpid/').reply(200, stub1);
	nock('http://www.zillow.com').get('/homes/19816799_zpid/').reply(200, stub2);
	nock('http://www.zillow.com').get('/homes/19711663_zpid/').reply(200, stub3);
